...
// CSS-only planet colors (no textures, no assets)
const planetColors: Record<
  PlanetId,
  { color1: string; color2: string }
> = {
  summary: { color1: "#4aa8ff", color2: "#003f80" }, // Earth-like
  experience: { color1: "#d1b38c", color2: "#7b6143" }, // Jupiter-like
  skills: { color1: "#6bb4ff", color2: "#003b9b" }, // Neptune-like
  education: { color1: "#d86b3d", color2: "#7a2a10" }, // Mars-like
  internships: { color1: "#e6c27a", color2: "#b48a47" }, // Venus-like
  projects: { color1: "#c8c8c8", color2: "#8b8b8b" }, // Mercury-like
  fun: { color1: "#e8d4a2", color2: "#a9976b" }, // Saturn-like
};
  ...
  return (
    <div
      ...
      style={{
        width: "100vw",
        height: "100vh",
        cursor: activePlanet ? "default" : "none",
      }}
    >
      {/* Inline CSS for demo */}
      <style>{`
        ...
        /* Parallax galaxy layers (CSS-only, no image assets) */
        .starfield,
        .starfield--mid,
        .starfield--slow {
          position: absolute;
        ...
        .starfield {
          background-image:
            radial-gradient(2px 2px at 20% 30%, rgba(148, 163, 255, 0.9) 0, transparent 50%),
            radial-gradient(1.5px 1.5px at 70% 60%, rgba(248, 250, 252, 0.8) 0, transparent 55%),
            radial-gradient(1.5px 1.5px at 40% 80%, rgba(56, 189, 248, 0.9) 0, transparent 55%),
            radial-gradient(2px 2px at 10% 70%, rgba(129, 140, 248, 0.8) 0, transparent 55%);
          opacity: 0.8;
        ...
        .starfield--slow {
          background-image:
            radial-gradient(2px 2px at 15% 20%, rgba(148, 163, 255, 0.6) 0, transparent 50%),
            radial-gradient(2px 2px at 65% 75%, rgba(248, 250, 252, 0.5) 0, transparent 55%);
        ...
        .planet__body {
          ...
          border-radius: 50%;
          background-image:
            radial-gradient(circle at 25% 25%, rgba(255,255,255,0.9) 0, rgba(255,255,255,0.05) 35%, transparent 60%),
            radial-gradient(circle at 130% 50%, rgba(0,0,0,0.8) 0, rgba(0,0,0,0.2) 55%, transparent 75%),
            radial-gradient(circle at 30% 30%, var(--planetColor1), var(--planetColor2));
          background-size: 180% 180%, 200% 200%, 140% 140%;
      ...
      <div className="space-map">
        {planets.map((planet, index) => {
          ...
          const colors = planetColors[planet.id];
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    "--planetColor1": colors.color1,
                    "--planetColor2": colors.color2,
                  }}
                />
